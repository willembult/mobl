...
public class MoBLParseController extends DynamicParseController
{
  public static final String LANGUAGE = new String("MoBL");
  ...
  private static void createDescriptor()
  {
    try
    {
      InputStream descriptorStream = MoBLParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MoBLParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MoBLParseController.class);
    }
  ...
  {
    return MoBLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
